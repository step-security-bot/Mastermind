...
2. Install [Python 3.8+](https://www.python.org/downloads/) if you haven't already.
...
3. Do you have the correct version of `python` installed? Check with the following command:
    ...
    If your python version is lower than 3.8, you need to upgrade your python version.
